...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-03-2021 a las 09:10:45
...
(1, '500.00', '422.80', 1, '2021-02-17 21:01:45');
...
(22, 21, 6, 3, '0.30', '2021-03-03 08:41:18'),
(23, 22, 6, 3, '0.30', '2021-03-03 08:42:49'),
(24, 23, 7, 5, '0.30', '2021-03-04 01:32:15'),
(25, 24, 6, 5, '0.30', '2021-03-04 01:33:31'),
(26, 25, 3, 6, '1.25', '2021-03-04 01:33:40'),
(27, 26, 5, 4, '0.30', '2021-03-04 01:55:00');
...
--
-- Estructura de tabla para la tabla `estado_log_caja`
--

CREATE TABLE `estado_log_caja` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

--
-- Volcado de datos para la tabla `estado_log_caja`
--

INSERT INTO `estado_log_caja` (`id`, `nombre`) VALUES
(1, 'gasto reservado'),
(2, 'gasto en producto'),
(3, 'Ingreso venta'),
(4, 'Abono Caja'),
...
(3, 'Recibos', 1, 2, '2021-03-03 08:47:42');
...
(3, 'Pago de una factura de tigo ayer ', '50.00', '2021-03-03 08:48:23', '2021-03-01', 1, 2, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `log_caja`
--

CREATE TABLE `log_caja` (
  `id` int(11) NOT NULL,
  `decripcion` varchar(200) COLLATE latin1_spanish_ci NOT NULL,
  `estado` int(11) NOT NULL,
  `id_venta` int(11) NOT NULL DEFAULT '0',
  `id_producto` int(11) NOT NULL DEFAULT '0',
  `id_gasto` int(11) NOT NULL DEFAULT '0',
  `id_proceso_caja` int(11) NOT NULL DEFAULT '0',
  `total` decimal(6,2) NOT NULL,
  `caja` decimal(6,2) NOT NULL DEFAULT '0.00',
  `fecha` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

--
-- Volcado de datos para la tabla `log_caja`
--

INSERT INTO `log_caja` (`id`, `decripcion`, `estado`, `id_venta`, `id_producto`, `id_gasto`, `id_proceso_caja`, `total`, `caja`, `fecha`) VALUES
(11, 'Se registro el producto ', 2, 0, 7, 0, 0, '5.50', '441.60', '2021-03-04 01:32:04'),
(12, 'Se registro la venta # ', 3, 23, 0, 0, 0, '1.50', '443.10', '2021-03-04 01:32:15'),
(13, 'Se registro la venta # ', 3, 24, 0, 0, 0, '1.50', '444.60', '2021-03-04 01:33:31'),
(14, 'Prestamo de medicina', 5, 0, 0, 0, 5, '12.00', '432.60', '2021-03-04 01:43:31'),
(15, 'Se registro la venta # 26', 3, 26, 0, 0, 0, '1.20', '433.80', '2021-03-04 01:55:00'),
(16, 'Se registro el producto Fresas', 2, 0, 8, 0, 0, '11.00', '422.80', '2021-03-04 01:56:52');
...
(4, 'arrayan', 'Galletas dieteticas', 10, '0.25', '0.30', '2021-03-03 08:35:05', 1, 2),
(5, 'arrayan', 'Galletas dieteticas', 6, '0.25', '0.30', '2021-03-03 08:35:17', 1, 2),
(6, 'aguacate', 'Galletas dieteticas', 0, '0.25', '0.30', '2021-03-03 08:36:07', 1, 2),
(7, 'aguacate', 'Galletas dieteticas', 17, '0.25', '0.30', '2021-03-04 01:32:04', 1, 2),
(8, 'Fresas', 'Galletas dieteticas', 44, '0.25', '1.25', '2021-03-04 01:56:52', 1, 2);
...
--
-- Estructura de tabla para la tabla `retiros_abonos`
--

CREATE TABLE `retiros_abonos` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `retiros_abonos`
--

INSERT INTO `retiros_abonos` (`id`, `descripcion`, `estado`, `total`, `fecha_creacion`, `fecha`) VALUES
(1, 'Prestamo de medicina', 2, '50.00', '0000-00-00 00:00:00', '2021-03-01 00:00:00'),
(2, 'Registro de caÃ±era', 1, '87.00', '0000-00-00 00:00:00', '2021-03-01 00:00:00'),
(3, 'Registro de caÃ±era', 1, '84.00', '0000-00-00 00:00:00', '2021-03-01 00:00:00'),
(4, 'Registro de caÃ±era', 1, '51.00', '0000-00-00 00:00:00', '2021-03-01 00:00:00'),
(5, 'Prestamo de medicina', 2, '12.00', '2021-03-04 01:43:31', '2021-03-01 00:00:00');
...
(21, 0, '2021-03-03 08:41:18', 2, 0),
(22, 0, '2021-03-03 08:42:49', 2, 0),
(23, 0, '2021-03-04 01:32:15', 2, 0),
(24, 0, '2021-03-04 01:33:31', 2, 0),
(25, 1, '2021-03-04 01:33:40', 2, 0),
(26, 0, '2021-03-04 01:55:00', 2, 0);
...
--
-- Indices de la tabla `estado_log_caja`
--
ALTER TABLE `estado_log_caja`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `log_caja`
--
ALTER TABLE `log_caja`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `retiros_abonos`
--
ALTER TABLE `retiros_abonos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `estado_log_caja`
--
ALTER TABLE `estado_log_caja`
...
--
-- AUTO_INCREMENT de la tabla `log_caja`
--
ALTER TABLE `log_caja`
...
--
-- AUTO_INCREMENT de la tabla `retiros_abonos`
--
ALTER TABLE `retiros_abonos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
